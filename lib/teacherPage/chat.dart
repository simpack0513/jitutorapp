                  ...
                  return Container(
                    ...
                    child: IntrinsicHeight(
                      child: Row(
                        ...
                        textDirection: (i % 2 == 1) ? TextDirection.rtl : TextDirection.ltr,
                        children: [
                          Container(
                            width: 40,
                            height: 40,
                          ...
                          Column(
                            crossAxisAlignment: (i % 2 == 1) ? CrossAxisAlignment.end : CrossAxisAlignment.start,
                            children: [
                              ...
                              Container(
                                ...
                                child: Text('테스트 택스트 테스트 택스트' + i.toString(), style: bodytextStyle,),
                              ),
                            ],
                          ),
                          Container(
